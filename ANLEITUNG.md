...
- **1.20 (2026-08-30):** Ein Versions-Rückstand bleibt nicht mehr im Bericht liegen. Der Wächter aus 1.19 meldet ihn; neu schlägt das LLM das Update dem Besitzer aktiv vor, in einer Zeile mit Ein-Wort-Antwort ("Dein Grundgerüst ist auf X, verfügbar ist Y; soll ich das Update ziehen?"), in jedem Nutzungsmodus. Im Modus `benutzen` zieht es das Update nach dem Ja selbst, ein Trigger-Wort braucht der Besitzer nicht zu kennen. Vollautomatisch ohne Ja läuft das Update weiterhin nie, weil es Kern-Dateien ersetzt und das angekündigt gehört. Damit schliesst sich die Lücke, dass verteilte Systeme still hinter dem Grundgerüst zurückbleiben. **Was du tun musst:** nichts; die Regel steckt in der AGENTS.md, Abschnitt 1.
